...
public class MenuPrincipalVista {
    ...
    private void mostrarMenuSolicitante() {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ordenVista.crearOrden(usuarioActual);
                    break;
                case 2:
                    despedida();
                    break;
    ...
    private void mostrarMenuOperario() {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    dependenciaVista.gestionarDependencias();
                    break;
                case 2:
                    solicitanteVista.gestionarSolicitantes();
                    break;
                case 3:
                    gestionarSolicitudesOperario();
                    break;
                case 4:
                    despedida();
                    break;
    ...
    private void gestionarSolicitudesOperario() {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    consultaVista.consultarOrdenes(usuarioActual);
                    break;
                case 2:
                    liquidacionVista.gestionarLiquidacion();
                    break;
                case 3:
                    break;
                default:
