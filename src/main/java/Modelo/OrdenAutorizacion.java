...
public class OrdenAutorizacion implements Validable {
    ...
    private List<EspecificacionTrabajo> especificaciones;
    private List<LiquidacionOperativa> liquidacionesOperativas;
    private List<LiquidacionAdicional> liquidacionesAdicionales;
    ...
    public void agregarEspecificacion(EspecificacionTrabajo e) {
        especificaciones.add(e);
    }

    public void agregarLiquidacionOperativa(LiquidacionOperativa lo) {
        liquidacionesOperativas.add(lo);
    }

    public void agregarLiquidacionAdicional(LiquidacionAdicional la) {
        liquidacionesAdicionales.add(la);
    }

    public void setLiquidacionFinal(LiquidacionFinal lf) {
        this.liquidacionFinal = lf;
    }
    ...
    public List<EspecificacionTrabajo> getEspecificaciones() {
        return especificaciones;
    }

    public List<LiquidacionOperativa> getLiquidacionesOperativas() {
        return liquidacionesOperativas;
    }

    public List<LiquidacionAdicional> getLiquidacionesAdicionales() {
        return liquidacionesAdicionales;
    }

    public LiquidacionFinal getLiquidacionFinal() {
